window.__EVERNOTE_I18N__ = {
 "generatedOn": "2017-Mar-22 17:47 PDT",
 ...
 "CheckoutInfoPane.switchTermTextLink.annually": "Switch to annual billing: save {{ 0 }}",
 "CheckoutInfoPane.switchTermTextLink.monthly": "Switch to monthly billing",
 ...
 "PlusInterstitialComponent.offer": "Limited time offer: Buy one year and get {{ 0 }}% off.",
 "PlusInterstitialComponent.goPremium.incentive": "Save {{ 0 }}% on Premium",
 ...
 "JoinBusinessAction.existingUserNewEmailInputPage.text": "Change the email on your existing account to keep your personal account. Your password will remain the same.",
