...
if ( ! function_exists( 'helena_sidebar' ) ) :
	/**
	 * Footer Sidebar
	 *
	 * @since Helena 0.1
	 */
	function helena_sidebar() {
		get_sidebar( 'footer' );
	}
	endif;
add_action( 'helena_after_content', 'helena_sidebar', 20 );
...
add_action( 'helena_footer', 'helena_site_info_start', 20 );
...
add_action( 'helena_footer', 'helena_footer_site_description', 30 );
...
add_action( 'helena_footer', 'helena_social_menu', 40 );
...
add_action( 'helena_footer', 'helena_site_info_end', 60 );
