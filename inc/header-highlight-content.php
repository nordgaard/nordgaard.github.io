...
if ( ! function_exists( 'helena_header_highlight_post_page_category_content' ) ) :
	...
	function helena_header_highlight_post_page_category_content() {
		...
		elseif ( 'header-highlight-category-content' == $type ) {
			...
			$args['category__in'] = (array) apply_filters( 'helena_get_option', 'header_highlight_content_select_category' );
		}
		...
		while ( $get_featured_posts->have_posts() ) {
			...
			$output .= '
			<article id="header-highlight-post-' . $i .'" class="post hentry header-highlight-post-content ' . $article_class . '">';
